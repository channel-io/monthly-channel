...
- 줌에서 DDB를 도입하게된 배경과 실제 설계한 내용에 대한 설명
...
- Resource 최적화를 위해 Kubernetes 환경에 배포되어 있는 JVM의 CPU requests 수를 2에서 1로 줄이자, memory 사용량이 증가한 원인분석 및 해결방법을 소개하는 글

### [reindex 성능 및 속도 최적화 방법](https://danawalab.github.io/elastic/2022/07/22/Reindex-Elasticsearch.html)
- Elasticsearch reindex 기능에 대해 설명하고, 환경에 따른 성능 지표를 제공하는 글
...
- 팀/프로젝트 단위로 jenkins 를 분리하고 이를 Prometheus 와 Grafana 를 통해 모니터링 및 알림을 구현을 소개하는 글
